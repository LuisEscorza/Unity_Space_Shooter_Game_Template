            ...
            if (AttackTimer >= FireRate)
            {
                ...
                switch (Amount)
                {
                    case 1:
                        ...
                        newProjectile = ObjectPoolManager.Manager.SpawnObject(_projectilePrefab, _projectileSpawnPoints[1].position, _projectileSpawnPoints[1].rotation, ObjectPoolManager.PoolType.PlayerProjectile).GetComponent<Projectile>();
                    ...
                    case 2:
                        for (int i = 0; i < Amount; i++)
                        {
                            ...
                            {
                                case 0:
                                    newProjectiles[i] = ObjectPoolManager.Manager.SpawnObject(_projectilePrefab, _projectileSpawnPoints[1].position, _projectileSpawnPoints[1].rotation, ObjectPoolManager.PoolType.PlayerProjectile).GetComponent<Projectile>(); ; break;
                                case 1:
